...
tunnel_service_port = int(os.environ.get("TUNNEL_SERVICE_PORT", "31022"))
...
job_extra_vars = {
    "+OWNER": '"' + name.split("-")[0] + '"',
    "+SingularityImage": '"/cvmfs/images.dodas.infn.it/ghcr.io/comp-dev-cms-ita/htcondor-dask-wn:v1.1.2"',
    "log": "wn.log",
    "output": "wn.out",
    "error": "wn.error",
